% Test barres SEG2 : rigidite et masse
clear all
close all
path(path,'../matlabEF') 
...
[rigi2,bsigma2,bepsilon2,d2] = Rigi9(modl1,matr2,mail1,intg1,xcoor1,mode1,...
                                     cara2,'GenDualOp','PrimOp','ConstiOp');
...
% Verification
XVAL1 = U1' * K1 * U1;
%if (abs(XVAL1 - 2.4142135624)/2.4142135624 > 1.E-10)
%if (abs(XVAL1 - 9.5680597162)/9.5680597162 > 1.E-10)
if (abs(XVAL1 - 8.4142135623)/8.4142135623 > 1.E-10)
  XVAL1
...
XVAL2 = U1' * M2 * U1;
if (abs(XVAL2 - 84.5522847498307)/84.5522847498307 > 1.E-10)
  XVAL2
