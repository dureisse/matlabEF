...
%[rigi2,bsig2,b2] = Rigi6(modl1,mater2,mail1,intg1,xcoor1,mode1);
%d2 = HookeOperator(mater2,mail1,intg1,mode1,idim);
...
eneref1 = 2.8571428571;
eneref1 = 3.4574684090;
eneref1 = 1.5384614730;
eneref1 = 1.53846153846;
ener1 = U1' * K1 * U1;
