...
err1 = abs(XVAL1 - 0.1436664377411858);
% Elem de ref, E = 0.5, nu = 0., epai = 0.2
err1 = abs(XVAL1 - 0.1029583333791665);
% Elem de ref x 4, E = 1, nu = 0.3, epai = 0.1
err1 = abs(XVAL1 - 17.062546932430401);
% Elem distordu, E = 1, nu = 0.3, epai = 0.1
err1 = abs(XVAL1 - 4.2651374419516387);
if (err1 > 1.e-8)
  error('probleme')
end
