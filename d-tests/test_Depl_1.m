% On teste la deformation plane en ELASTIQUE, RIGIDITE et MASSE
...
[rigit1,bsigt1,bepst1,hooket1] = RigiCompress8(modl3,mater3,mail1,intg3, ...
                                               xcoor1,mode, ...
                                 'GenDualOp','PrimOp','ConstiOp');
...
XVAL1 = U1' * M1 * U1;
if (abs(XVAL1 - 1.0194935830)/1.0194935830) > 1.E-6
  XVAL1
  error('mauvaise valeur 1')
end
XVAL2 = U1' * K1 * U1;
if (abs(XVAL2 - 1.8821206542)/1.8821206542) > 1.E-6
  XVAL2
...
KT1 = RigiToMatrix(rigit1,modl3,mail1, ...
                  ...
                  numer1,mapddlPrim3,listDdlPrim3);
XVAL3 = U3' * KT1 * U3;
if (abs(XVAL3 - 0.0135809381873)/0.0135809381873) > 1.E-6
  XVAL3
  error('mauvaise valeur 3')
end
U4 = ChpoToVect3(tchpo1,tnmail1,tnumer1,mapddlPrim5,listDdlPrim5);
XVAL4 = U4' * H1 * U4;
if (abs(XVAL4 - 0.37065556711)/0.37065556711) > 1.E-6
  XVAL4
