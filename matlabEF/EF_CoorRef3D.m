function [idans,Xcor2,shp1,xcor2] = EF_CoorRef3D(type1,Xcorel1,xcorel1, ...
                                                xcor1,xcrit1,xcrit2)
% Look for natural cooridnates of a point in an element
%
% DUREISSEIX David  L.M.G.C. SYSTEMES MULTICONTACT  le 02 / 07 / 2006
%   Cas 3D cree a partir du 2D
% 
...
% On sous-decoupe l'element en tetrahedres, et on cherche les coordonnees
% barycentriques dans les tetrahedres
...
if strcmp(type1,'TET4')
  ...
  Xp0 = Xcorel1(1,:);
  xp0 = xcorel1(1,:);
  clear ial; ial(1) = 2; ial(2) = 3; ial(3) = 4;
  [idans,al] = Efbary(xp0,xcorel1',ial,xcor1,xcrit2);

elseif strcmp(type1,'PRI6')

  if ~idans
    clear ial; ial(1) = 1; ial(2) = 2; ial(3) = 3;
    [idans,al] = Efbary(xp0,xcorel1',ial,xcor1,xcrit2);
  end
  if ~idans
    clear ial; ial(1) = 1; ial(2) = 2; ial(3) = 4;
    [idans,al] = Efbary(xp0,xcorel1',ial,xcor1,xcrit2);
  end
  if ~idans
    clear ial; ial(1) = 2; ial(2) = 5; ial(3) = 4;
    [idans,al] = Efbary(xp0,xcorel1',ial,xcor1,xcrit2);
  end
  if ~idans
    clear ial; ial(1) = 2; ial(2) = 3; ial(3) = 5;
    [idans,al] = Efbary(xp0,xcorel1',ial,xcor1,xcrit2);
  end
  if ~idans
    clear ial; ial(1) = 3; ial(2) = 5; ial(3) = 6;
    [idans,al] = Efbary(xp0,xcorel1',ial,xcor1,xcrit2);
  end
  if ~idans
    clear ial; ial(1) = 1; ial(2) = 3; ial(3) = 4;
    [idans,al] = Efbary(xp0,xcorel1',ial,xcor1,xcrit2);
  end
  if ~idans
    clear ial; ial(1) = 3; ial(2) = 6; ial(3) = 4;
    [idans,al] = Efbary(xp0,xcorel1',ial,xcor1,xcrit2);
  end
  if ~idans
    clear ial; ial(1) = 4; ial(2) = 5; ial(3) = 6;
    [idans,al] = Efbary(xp0,xcorel1',ial,xcor1,xcrit2);
  end
