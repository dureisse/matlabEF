function [PHI,DPHI,COOR,WEIGHT] = TE10d_Poreux_SegmentIntegr3( ...
                                             support1,mode1,varargin);
% Integration information for TE10 straight edge geometric element
% for porous case
%
...
%   TRID
    ...
    nbnni = 10+4; % Nombre de fonctions de base
