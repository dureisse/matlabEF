function [listComp1,listUnit1] = ListCompChpo2(chpo1,list_zones);
% DUREISSEIX David    L.M.T. STRUCTURES et SYSTEMES  le 31 / 07 / 2002

% Renvoie les composantes d'un champ par point
...
if (narg == 1)
  [listComp1,listUnit1] = ListCompCh2(chpo1);
elseif (narg == 2)
  [listComp1,listUnit1] = ListCompCh2(chpo1,list_zones);
else
