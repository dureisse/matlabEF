function [PHI,DPHI,COOR,WEIGHT] = TET5_Poreux_SegmentIntegr3( ...
                                             support1,mode1,varargin);
% Integration information for TET5 geometric element for porous case
%
% TET5 is a TET4 element plus a bubble-like 5th node at the centroid
...
%   Surcharge eventuelle
    ...
    for ptg = 1:nbptg
      PHI(1:5,ptg)    = EF_Shape('TET5',COOR(ptg,:))'; % attention au '
      PHI(6:9,ptg)    = EF_Shape('TET4',COOR(ptg,:))'; % attention au '
      DPHI(:,1:5,ptg) = EF_Dshape('TET5',COOR(ptg,:));
